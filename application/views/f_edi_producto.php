   ...
   <div class="vista-dere">
    <div class="form-reg">
        <form action="http://localhost/mitienda/index.php/Cproducto/g_edi_producto/<?php echo $id_producto;?>" method="post">
            ...
            <input type="text" name="nom_producto" value="<?php echo $nombre_producto;?>" requerid>
            <input type="number" name="cantidad" value="<?php echo $cantidad;?>" requerid>
            <input type="text"  name="detalle" value="<?php echo $detalle;?>" requerid>
            <input type="number"  name="pre_compra" value="<?php echo $precio_compra;?>" requerid step=".01">
            <input type="number"  name="pre_venta" value="<?php echo $precio_venta;?>" requerid step=".01">
            <div class="sec-btn">
