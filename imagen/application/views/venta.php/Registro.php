        ...
        <form>
          ...
          <div class="form-group">
            <label for="formGroupExampleInput2">Detalle</label>
						<textarea class="form-control" name="detalle_p" placeholder=" * Describa su Producto"></textarea>
						<div id="respuesta_apellido" style="display:block;color:red;"></div>
          </div>
          <div class="form-group">
            <label for="formGroupExampleInput2">Precio</label>
						<input type="number" class="form-control" id="edad" placeholder="* precio" name="edad" min="0" onkeypress="return soloNumeros(event) " max="3" required>
						<div id="respuesta_edad" style="display:block;color:red;"></div>
					</div>
					<div class="form-group">
            <label for="formGroupExampleInput2">Portada</label>
						<input type="file" class="form-control" id="edad" placeholder="* Escriba su Edad" name="file" min="0" required>
          </div>
